...
export const REPORT_BASE_STYLE = `<style>
  ...
  *:not(html):not(body) { max-width: 100%; }
  ...
  :where(.brief, body > article, body > main) {
    width: min(100%, var(--report-maxw)); margin: 0 auto;
    padding: clamp(var(--sp-4), 4vw, var(--sp-6)) var(--sp-4) var(--sp-7);
    overflow-wrap: anywhere;
  }
  :where(.brief, body > article, body > main) section { margin: var(--sp-6) 0; }
  :where(.brief, body > article, body > main) section:first-child { margin-top: 0; }
  :where(.brief, body > article, body > main) h2 { margin: 0 0 var(--sp-3); font-size: var(--step-2); line-height: 1.2; font-weight: 640; color: var(--text, #1c1b19); }
  :where(.brief, body > article, body > main) p { margin: var(--sp-2) 0; }
  :where(.brief, body > article, body > main) ul,
  :where(.brief, body > article, body > main) ol { margin: var(--sp-3) 0 0; padding-left: 1.35em; }
  :where(.brief, body > article, body > main) li { margin: var(--sp-2) 0; line-height: 1.55; }
  :where(.brief, body > article, body > main) strong { font-weight: 640; }

  /* Summary card (.lede / .headline / .keypoints). */
  :where(.brief, body > article, body > main) .lede {
  ...
  :where(.brief, body > article, body > main) .headline { margin: 0; font-size: var(--step-1); line-height: 1.45; font-weight: 560; color: var(--text, #1c1b19); }
  :where(.brief, body > article, body > main) .keypoints { list-style: none; margin: var(--sp-4) 0 0; padding-left: 0; }
  :where(.brief, body > article, body > main) .keypoints li { position: relative; margin: 0; padding: var(--sp-2) 0 var(--sp-2) var(--sp-5); border-top: 1px solid var(--border, #e4e1dc); }
  :where(.brief, body > article, body > main) .keypoints li:first-child { border-top: 0; }
  :where(.brief, body > article, body > main) .keypoints li::before { content: ""; position: absolute; left: var(--sp-1); top: 1.15em; width: 7px; height: 7px; border-radius: 50%; background: var(--accent, #6d5ef0); }

  /* Numbered section header (.sec-head + .sec-num badge). */
  :where(.brief, body > article, body > main) .sec-head { display: flex; align-items: center; gap: var(--sp-3); margin-bottom: var(--sp-4); }
  :where(.brief, body > article, body > main) .sec-head h2 { margin: 0; }
  :where(.brief, body > article, body > main) .sec-num {
  ...
  :where(.brief, body > article, body > main) .items { display: grid; gap: var(--sp-4); }
  :where(.brief, body > article, body > main) .items > details { margin: 0; }
  :where(.brief, body > article, body > main) .item p.lead,
  :where(.brief, body > article, body > main) p.lead { margin-top: 0; }
  :where(.brief, body > article, body > main) .meta { display: grid; gap: var(--sp-2); margin: var(--sp-3) 0 0; }
  :where(.brief, body > article, body > main) .meta > div { display: grid; grid-template-columns: minmax(4.5rem, 6rem) 1fr; gap: var(--sp-3); align-items: baseline; font-size: var(--step--1); }
  :where(.brief, body > article, body > main) .meta dt,
  :where(.brief, body > article, body > main) .meta .k { margin: 0; color: var(--muted, #6b6862); letter-spacing: 0; font-size: .72rem; font-weight: 650; }
  :where(.brief, body > article, body > main) .meta .v { color: var(--text, #1c1b19); }
  :where(.brief, body > article, body > main) .meta .v.action { color: var(--accent, #6d5ef0); font-weight: 560; }

  /* Status badges — color-mix tint keeps them theme-agnostic. */
  :where(.brief, body > article, body > main) .badge {
  ...
  :where(.brief, body > article, body > main) .badge.done,
  :where(.brief, body > article, body > main) .badge.fixed { color: var(--green, #3fb984); }
  :where(.brief, body > article, body > main) .badge.hold,
